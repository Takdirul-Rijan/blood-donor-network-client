...
const VolunteerHome = () => {
  ...
  const { data: stats = {}, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const res = await axiosSecure.get("/volunteer/dashboard-stats");
      return res.data;
    },
  });
    ...
    <div>
      <h1 className="text-3xl font-bold mb-6">
        ...
        <span className="text-xl text-green-600">
          Welcome to the BloodConnect Volunteer Community! 💐
        </span>
        <br />
        <span className="text-xl text-green-600">
          Your efforts help save lives every day. Let's manage donation requests
